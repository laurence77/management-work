...
-- Insert sample celebrities (only if table is empty)
INSERT INTO celebrities (name, category, price, description, availability, rating, bookings)
SELECT * FROM (VALUES
...
) AS new_celebrities(name, category, price, description, availability, rating, bookings)
